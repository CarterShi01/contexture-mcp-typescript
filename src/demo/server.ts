...
import { ContextureOptions } from '../server/options.js';

export const rollBackARelease = {
...
export const crashLoopRunbookDocument = {
...
export const rollbackPolicyDocument = {
...
export const app = defineApplication({
  ...
  resources: [crashLoopRunbookDocument, rollbackPolicyDocument],
});
...
export async function main(): Promise<void> {
  await build().start(new ContextureOptions());
}
