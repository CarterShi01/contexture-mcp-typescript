...
try {
  ...
  const consumer = [
    ...
    "import { Auth, buildServer, claudeCodeConfig, compileRuntimeApplication, ContextureOptions, DisclosureAPI, DISCLOSURE_GATEWAY, EXECUTION_GATEWAY, ExecutionAPI, Gateway, GATEWAY, GATEWAY_TOOLS, HeaderRootSelector, HeaderSurfaceSelector, Launch, Refused, ROOTS_HEADER, SELECT_HEADER, ServeError, SystemAPI, unresolvedMessage } from '@contexture/mcp/server';",
