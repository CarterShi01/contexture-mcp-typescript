...
try {
  ...
  const consumer = [
    ...
    "import { ApplicationRuntime, Auth, buildServer, claudeCodeConfig, COMMAND_CLOSING, commandDescription, compileRuntimeApplication, compileStructuralApplication, ContextureOptions, currentTelemetry as serverCurrentTelemetry, DisclosureAPI, DISCLOSURE_GATEWAY, EXECUTION_GATEWAY, ExecutionAPI, Gateway, GATEWAY, GATEWAY_TOOLS, GOTO_DESCRIPTION, HeaderRootSelector, HeaderSurfaceSelector, InMemoryTelemetry as ServerInMemoryTelemetry, Launch, PREAMBLE, Refused, REF_RULE, reportTelemetry as serverReportTelemetry, ROOTS_HEADER, SELECT_HEADER, ServeError, signpost, SystemAPI, truncatedCompletion, unresolvedMessage, withTelemetry as serverWithTelemetry } from '@contexture/mcp/server';",
