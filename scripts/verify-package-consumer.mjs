...
try {
  ...
  const consumer = [
    ...
    "import { Auth, claudeCodeConfig, compileRuntimeApplication, ContextureOptions, DisclosureAPI, DISCLOSURE_GATEWAY, EXECUTION_GATEWAY, Gateway, GATEWAY, HeaderRootSelector, Launch, ServeError, unresolvedMessage } from '@contexture/mcp/server';",
